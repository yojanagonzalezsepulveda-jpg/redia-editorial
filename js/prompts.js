...
Responde SOLO con JSON válido — genera "articulo" PRIMERO (es lo más importante), luego los demás campos:
{"titulo_seo":"máx 60 chars","descripcion_seo":"MÁXIMO 140 CARACTERES — idea completa y cerrada, nunca cortada a la mitad. Si no cabe, reformula más corto. Sin punto final","tags":["t1","t2","t3","t4"],"categoria":"noticia","tiempo_lectura":"X min","fuentes_consultadas":["Medio o fuente 1","Medio o fuente 2","Medio o fuente 3"],"fuentes_con_links":[{"nombre":"Nombre real del medio","url":"https://url-exacta-del-articulo.cl/nota-especifica","fecha":"DD/MM/YYYY","descripcion":"Qué aportó esta fuente"},{"nombre":"Fuente 2","url":"https://url-exacta-articulo2.cl/nota","fecha":"DD/MM/YYYY","descripcion":"Qué aportó"},{"nombre":"Fuente 3","url":"https://url-exacta-articulo3.cl/nota","fecha":"DD/MM/YYYY","descripcion":"Qué aportó"}],"imagen_prompt":"Prompt fotorrealista en inglés para Gemini Imagen 3. Específico al tema. 16:9","articulo":{"titular":"titular periodístico directo con dato concreto","bajada":"2-3 oraciones con el hecho más relevante y cifra concreta, con fuente entre paréntesis","cuerpo":"MARKDOWN: ## subtítulos, **datos clave** en negrita, párrafos con fuente entre paréntesis. Sin citas textuales. Mín ${minW} palabras.","analisis_muestra":"Lo que muestra este análisis — qué revela para el sector acuícola, en 2-4 puntos concretos basados solo en los datos entregados"},"linkedin":"Post LinkedIn informativo sobre el eje central. Tono profesional, no publicitario. Emojis sectoriales (🐟🌊⚓). Incluye link redia.pro al final. Máx 1200 caracteres.","facebook":"Post Facebook conversacional sobre el mismo eje. Más cercano. Incluye link redia.pro. Máx 500 caracteres."}`;
}
...
[
  {
    ...
    "descripcion_seo": "MÁXIMO 140 CARACTERES — idea completa y cerrada, nunca cortada a la mitad. Si no cabe, reformula más corto. Sin punto final",
    "tags": ["t1","t2","t3","t4"],
    "categoria": "Categoría",
